...
func TestSaverPost_Success(t *testing.T) {
	...
	foodApp.SavePostFn = func(*entity.Post) (*entity.Post, map[string]string) {
		return &entity.Post{
			...
			Image:       "dbdbf-dhbfh-bfy34-34jh-fd.jpg",
		}, nil
	}
	...
	assert.EqualValues(t, food.Image, "dbdbf-dhbfh-bfy34-34jh-fd.jpg")
}
	...
	foodApp.GetAllPostFn = func() ([]entity.Post, error) {
		return []entity.Post{
			...
			},
			{
				...
				Image:       "dbdbf-dhbfh-bfy34-34jh-fd-second.jpg",
			},
		}, nil
	}
...
func TestUpdatePost_Success_With_File(t *testing.T) {
	...
	foodApp.UpdatePostFn = func(*entity.Post) (*entity.Post, map[string]string) {
		return &entity.Post{
			...
			Image:       "dbdbf-dhbfh-bfy34-34jh-fd-updated.jpg",
		}, nil
	}
	...
	assert.EqualValues(t, food.ID, 1)
	assert.EqualValues(t, food.UserID, 1)
	assert.EqualValues(t, food.Title, "Post title updated")
	assert.EqualValues(t, food.Description, "Post description updated")
	assert.EqualValues(t, food.Image, "dbdbf-dhbfh-bfy34-34jh-fd-updated.jpg")
}
...
func TestUpdatePost_Success_Without_File(t *testing.T) {
	...
	foodApp.GetPostFn = func(uint64) (*entity.Post, error) {
		return &entity.Post{
			...
			Title:       "Post title",
			Description: "Post description",
			Image:       "dbdbf-dhbfh-bfy34-34jh-fd-old-file.jpg",
		}, nil
	}
	//Mocking The Post return from db
	foodApp.UpdatePostFn = func(*entity.Post) (*entity.Post, map[string]string) {
	...
	assert.EqualValues(t, food.Title, "Post title updated")
	assert.EqualValues(t, food.Description, "Post description updated")
	assert.EqualValues(t, food.Image, "dbdbf-dhbfh-bfy34-34jh-fd-old-file.jpg")
}
